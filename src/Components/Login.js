  ...
  render(){
    return(
      <div className="login-page">
        <h2 className="login-page-header-text login-page-header-text-lg"> WELCOME TO FRIDGEnHUNGRY!  </h2>
        <h5 className="login-page-header-text login-page-header-text-sm"> Please Login in to Continue </h5>
        <form className="login-page-form" onSubmit={(e) => this.submitHandler(e)}>
